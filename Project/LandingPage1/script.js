...
// Detect page and show correct switch button
if (window.location.href.includes("landing-page-1")) {
    document.getElementById("switchCU").style.display = "inline-block";
} else {
    document.getElementById("switchLPU").style.display = "inline-block";
}
